        ...
        <>
            ...
            <main>
                <section>
                    ...
                    <article className="textleft installplan__section marginbot4020">
                        <h4 className="marginbot4020">В нашем магазине Вы можете приобрести выбранный товар в рассрочку на очень
                    привлекательных условиях от разных банков: ПриватБанка, ОТП Банка, УкрСиббанка.</h4>
                        <article className="flexbet flexwrap marginbot4020 installplan__icons">
                        ...
                        <h3 className="marginbot2010">Рассрочка от «УкрСиббанка»</h3>
                        <h6 className="marginbot2010">Уточняйте у менеджеров наличие товара и его цену!</h6>
                        <h4 className="marginbot4020">Оформление кредита осуществляется в ближайшем к Вам от делении «УкрСиббанка»
                        ...
                        для Вас отделение Вашего города.
                </h4>
                        <h4 className="marginbot4020">Данные указаны для ознакомления. Программы могут меняться банком без
                    предупреждения.</h4>
                        ...
                        <h3 className="marginbot2010">«Мгновенная рассрочка» и «Оплата частями»* от ПриватБанка</h3>
                        <h6 className="marginbot2010">Уточняйте у менеджеров наличие товара и его цену!</h6>
                        <h4 className="marginbot4020">* В случае подключения услуги «Оплата частями» от ПриватБанка, цена на товар
                    может меняться.</h4>
                        <h4 className="marginbot4020">Оформление за 1 минуту! Процедура оформления «Мгновенной рассрочки» или
                    ...
                    ПриватБанка. Чек об оплате является Вашим Договором с банком по рассрочке.</h4>
                        <a href=" " className="marginbot2010">Скачать калькулятор рассрочки</a>
                        <h3 className="marginbot2010">Преимущества «Мгновенной рассрочки» и «Оплаты частями»</h3>
                        <h5 className="marginbot2010">Экономия времени - оформление покупки за 30 секунд</h5>
                        <h5 className="marginbot2010">Простота оформления - договором является чек со всеми необходимыми реквизитами
                        (не нужно никаких документов: справка
                    о доходах, ИНН, паспорт)</h5>
                        <h5 className="marginbot4020">Удобное погашение - вносить платежи на карту можно без посещения банка</h5>
                        <h3 className="marginbot2010">Условия «Мгновенной рассрочки» и «Оплаты частями»</h3>
                        <h5 className="marginbot2010">Оформить Мгновенную рассрочку можно на срок от 1 до 24 месяцев.</h5>
                        <h5 className="marginbot2010">Комиссия в месяц за услугу составляет: для «Мгновенной рассрочки» - 2,9% от
                    суммы покупки, для «Оплаты частями» - 0%.</h5>
                        <h5 className="marginbot4020">Если вы оплачиваете регулярный платеж за счет собственных средств, то списание
                        платежа происходит без комиссии.
                    В счет кредитных средств комиссия за платеж составит 4%.</h5>
                        <h4 className="marginbot4020">Данные указаны для ознакомления. Программы могут меняться банком без
                    предупреждения.</h4>
                        ...
                        <h3 className="marginbot2010">«Мгновенная рассрочка» и «Оплата частями»* от ОТП Банка</h3>
                        <div className="banks__img marginbot2010">
                            <img src={photo_009} alt="" />
                        </div>
                        <h6 className="marginbot2010">Уточняйте у менеджеров наличие товара и его цену!</h6>
                        <h4 className="marginbot4020">Оформить рассрочку от «ОТП Банка» Вы можете в любом отделении ОТП Банка по
                    ...
                    оформление в удобное для Вас отделение Вашего города.</h4>
                        <h4 className="marginbot4020">Все вопросы по своим платежам клиенты могут уточнить по тел. 0-800-503-505
                </h4>
                        <h4 className="marginbot4020">Телефон для консультации по рассрочке: <span className="bold">099-053-66-50 (ОТП
                        Банк)</span> (с 9 00 до 20 00 в будние дни, в выходные дни с 10 00 до 20 00).</h4>
                        <h4 className="marginbot4020">Данные указаны для ознакомления. Программы могут меняться банком без
                    предупреждения.</h4>
                        <table className="otp__bank marginbot4020">
                            <tbody>
                                ...
                                <tr>
                                    <td>Документы для оформления</td>
                                    <td>- Паспорт гражданина Украины <br />
                            - Идентификационный код</td>
                                </tr>
                                <tr>
                                    <td>Срок кредитования</td>
                        ...
                        <h2 className="marginbot4020">Другие банки</h2>
                        <table className="others__bank">
                            <tbody>
                                <tr>
                                    <th>Наименование Банка</th>
                                    <th>Вид продажи</th>
                                    <th>Период кредитования, <br />
                            мес</th>
                                    <th>Возраст заемщика, <br />
                            лет</th>
                                    <th>Дополнительные
                            условия</th>
                                    <th>Перечень
                            ...
                            документов</th>
                                ...
                                <tr>
                                    ...
                                    <td>До 24</td>
                                    <td>18-70</td>
                                    <td rowSpan="4">Стаж на текущем месте
                                    работы- не меньше
                                    3 месяцев.
                                    На усмотрение
                                    банка кредиты
