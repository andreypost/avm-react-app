...
export const SeoMailing = () => {
    ...
    return (
        <>
            ...
            <section className="seo__section textleft">
                <div>
                    <h2 className="marginbot2010 bold">Интернет-магазин АудиоВидеоМир - лучший выбор Hi-Fi техники в Украине
                </h2>
                    <p>Что может быть лучше ярких и четких звуков, передающих тембр голоса, журчание воды, пение птиц,
                    звучание
                    ...
                    купить Hi-Fi акустика и Hi-Fi технику, которую вы сможете найти в нашем магазине.</p>
                    <p>Какие товары можно купить в интернет-магазине АудиоВидеоМир?</p>
                    <p>Наш интернет магазин аудио видео техники предлагает вам огромный выбор профессиональных аудио и
                    ...
                    и регенераторов, стерео ресиверов и прочей аудио техники.</p>
                    <p>На страницах нашего сайта вы сможете сначала выбрать, а затем и купить Hi-Fi технику, AV процессоры
                    ...
                    сетевые, силовые, цифровые и межблочные кабели, аксессуары.</p>
                    <p>По вашему желанию вас ждет высокочастотная и высококачественная Hi-End техника, которую можно
                    ...
                    <p>В чем преимущества наших клиентов?
                    ...
                    виртуальный зал прослушивания.</p>
                    <p>С нашим магазином вам не нужно будет искать дополнительную мебель и крепежные материалы. Ваша
                    ...
                    пульты, докстанции и аудиосистемы для I-Pod, прочие IT-технологии, аксессуары и комплектующие.</p>
                    <p>Вас ждут интересные акционные предложения, скидки, розыгрыши призов и приятные подарки от наших
                    ...
                    офиса, супермаркета, торгового центра, клуба, кинотеатра и прочих помещений в кратчайшие сроки.</p>
                    <p>Наша аудио-видео техника – самая качественная, надежная и многофункциональная. Она достойна вашего
                    внимания и позволит вам наслаждаться идеальным звучанием прослушиваемого материала снова и снова.
                </p>
                    <p>Только современная Hi-End техника, актуальные модели и достойный перечень сопутствующих товаров.
                    Заходите к нам чаще. И поверьте, вы не разочаруетесь! Мы всегда рады вас видеть!</p>
                </div>
                <p className="see__seo">Смотреть больше</p>
            </section>
        </>
    )
}
