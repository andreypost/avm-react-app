        ...
        return (
            <div className="item discount__card" >
                ...
                <div className="description__card">
                    ...
                    <Link to="ProcardBase" className="products__name">{this.props.datos.title}</Link>
                </div>
                ...
                <div className="products__div flexbet alignend">
                    <div className="products__info flexcol alignstart">
                        <h5 className="discount__price flexcenter relative">{this.props.datos.basePrice}<span>&nbsp;грн</span></h5>
                        <h3 className="products__price flexcenter">{this.props.datos.price}<span>&nbsp;грн/<br />&nbsp;комплект</span></h3>
                    </div>
