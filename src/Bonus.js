        ...
        <>
            ...
            <main>
                <section>
                    ...
                    <article className="textleft bonus__article marginbot4020">
                        <h1 className="marginbot2010">Бонусная программа</h1>
                        <div className="bonus__img marginbot2010 textcenter">
                            <img src={photo_001} alt="" />
                        </div>
                        <h3 className="bold marginbot2010">Дорогие Покупатели!</h3>
                        <p className="marginbot4020">Для того чтобы Ваши покупки были не только быстрыми и надежными, но еще и
                    ...
                    и на покупки в <span className="bold">Рассрочку</span>.</p>
                        <p className="marginbot4020">Каждый новый Покупатель, дав свое устное согласие, становится участником нашей
                    Дисконтной программы, а значит – нашим <span className="bold">Постоянным Клиентом</span>. Ему становится
                    доступна наша hi fi бонусная система для покупателей.</p>
                        <p className="marginbot4020">Все, что Вам нужно, чтобы получать скидки от 5% и выше – это совершать покупки
                    ...
                    магазина.</p>
                        <ul>
                            <li className="bold">Для того чтобы воспользоваться Вашим дисконтом:</li>
                            <li className="dashInside">в случае заказа по телефону – назовите Ваше <span className="bold">Имя, Фамилию и
                            Номер
                            телефона,</span></li>
                            <li className="dashInside marginbot4020">в случае заказа через сайт, с Вами свяжется наш менеджер для
                            уточнения
                        данных.</li>
                        </ul>
                        <p className="marginbot4020">Воспользоваться Вашей скидкой могут также <span className="bold">Ваши друзья и
                    ...
                    бонусная система работает на него сразу же, даже с первой покупки по Вашей скидке.</p>
                        <p></p>
                        <h3 className="bold marginbot4020">Условия дисконтной программы</h3>
                        <table className="marginbot4020">
                            <tbody>
                                <tr>
                        ...
                        <p className="marginbot4020"><span className="bold">Дисконтная программа «АУДИО ВИДЕО МИР»</span> – это система
                    поощрения постоянных покупателей интернет-магазина «АУДИО ВИДЕО МИР», основанная на предоставлении
                    скидок на товары магазина в зависимости от общей суммы ранее совершенных покупок.</p>
                        <p className="marginbot4020"><span className="bold">Постоянный Клиент</span> - любой покупатель
                    интернет-магазина «АУДИО ВИДЕО МИР», который устно дал свое согласие на участие в Дисконтной
                    программе. Постоянный Клиент идентифицируется следующими данными: Имя, Фамилия, Номер телефона.</p>
                        <p className="marginbot4020"><span className="bold">Накопленная сумма покупок</span> – это сумма всех покупок,
                    ...
                    скидок.</p>
                        <p className="marginbot4020"><span className="bold">Скидки не суммируются.</span>Если на товар уже установлена
                    скидка (например, акционный товар, уценка и т.п.), то размер суммарной Скидки Постоянного Клиента
                    оговаривается с менеджером в индивидуальном порядке.</p>
                        <p className="marginbot4020"><span className="bold">Возврат товара.</span>В случае возврата товара Накопленная
                    сумма покупок уменьшается на сумму возврата. При этом размер Скидки Постоянного Клиента изменяется
                    согласно данным Условиям.</p>
                        <p className="marginbot4020">Компания «АУДИО ВИДЕО МИР» оставляет за собой право изменять условия данной
                        Дисконтной программы без личного уведомления участников программы путем размещения новых условий на
                    веб-сайте <a href=" " className="underline"> www.audiovideomir.com.ua.</a></p>
                        <p className="marginbot4020">Компания «АУДИО ВИДЕО МИР» гарантирует, что не будет передавать личные данные
                    ...
                    предложениях.</p>
                        <p className="marginbot4020">Кроме брендов: Yamaha, Klipsch, Tannoy, Sonus Faber, Pro-Ject, Furman, Unison
                    ...
                    Nordost, Burmester, Kimber Kable, Cabasse, Aurea, Denon, LW Speakers, Meridian, AMR.</p>
                    </article>
                </section>
                <SeoMailing />
            </main>
